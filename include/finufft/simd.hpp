...
// The release flags carry -fassociative-math, which clang and gcc before 12 report
// through no macro of their own. Without this xsimd drops the barriers that keep its SSE2
