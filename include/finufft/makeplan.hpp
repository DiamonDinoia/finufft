...
template<typename TF> void FINUFFT_PLAN_T<TF>::setup_spreadinterp() {
  ...
  */
  ...
  // fallback only: indexSort() recomputes this from measured bin occupancy once the
  // NU points are known (see heuristics::max_subproblem_size)
  m.spopts.max_subproblem_size = (dim == 1) ? 10000 : 100000;
