...
// Per-dimension TU: explicit instantiation of 1D entry points for one precision.
...
template void FINUFFT_PLAN_T<FLT>::spread_subproblem_dispatch_1d(
    BIGINT, UBIGINT, FLT *FINUFFT_RESTRICT, UBIGINT, const FLT *,
