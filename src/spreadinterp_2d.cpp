...
// Per-dimension TU: explicit instantiation of 2D wrapper templates for one precision.
...
template void FINUFFT_PLAN_T<FLT>::spread_subproblem_dispatch<2>(
...
template int FINUFFT_PLAN_T<FLT>::interpSorted_dispatch<2>(FLT *, FLT *) const;
