...
set(tempout "${CMAKE_CURRENT_BINARY_DIR}/dumbinputs${CMAKE_ARGV3}.out")
...
execute_process(
    COMMAND ${CMAKE_CURRENT_BINARY_DIR}/dumbinputs
    OUTPUT_FILE ${tempout}
)
...
execute_process(
    COMMAND
        ${CMAKE_COMMAND} -E compare_files --ignore-eol ${tempout}
        ${CMAKE_CURRENT_SOURCE_DIR}/results/dumbinputs${CMAKE_ARGV3}.refout
)
...
if(0)
    ...
    set(tempout "${CMAKE_CURRENT_BINARY_DIR}/dumbinputs${SUFFIX}.out")
    ...
    add_test(
        ...
        COMMAND
            ${CMAKE_COMMAND} -E compare_files ${tempout}
            ${CMAKE_CURRENT_SOURCE_DIR}/results/dumbinputs${SUFFIX}.refout
    )
endif()
...
add_test(
    NAME check_dumbinputs_${PREC}
    COMMAND
        ${CMAKE_COMMAND} -P ${CMAKE_SOURCE_DIR}/devel/check_dumbinputs.cmake
        ${SUFFIX}
)
